...
def ver_produtos():
    ...
    lbl_nome = Label(janela_vu, text='VER LISTA DE PRODUTOS CADASTRADOS', font='Congenial 14 bold', bg='#F0F8FF')
    lbl_nome.place(x=60, y=15)

    lbl_des0 = Label(janela_vu, text='ID', bg='#F0F8FF')
    lbl_des0.place(x=48, y=50)

    lbl_des1 = Label(janela_vu, text='NOME', bg='#F0F8FF')
    lbl_des1.place(x=117, y=50)

    lbl_des2 = Label(janela_vu, text='PREÇO/V', bg='#F0F8FF')
    lbl_des2.place(x=188, y=50)

    lbl_des3 = Label(janela_vu, text='QUANT', bg='#F0F8FF')
